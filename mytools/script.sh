...
CUDA_VISIBLE_DEVICES=0,1,2,3,6,7  python run_net.py  --cfg configs/SSv2/SLOWFAST_16x8_R50.yaml \
  DATA.PATH_TO_DATA_DIR /data/lifengjun/gesture_dataset/dataset/
