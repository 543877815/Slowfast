...
if __name__ == '__main__':
    input_size = 256
    preprocess = transforms.Compose([transforms.transforms.Resize([input_size, input_size]),
    ...
    path = r"H:\gesture_project\mydivide\test\0"
    for img in os.listdir(path):
        ...
        print(cls)
        weights = net._modules.get('classifier').weight.data[cls, :]  # 获取类别对应的权重
        ...
        # result.show()
        result.save('./cams/{}'.format(os.path.basename(img_path)))
